...
export interface CellRendererOptions extends RendererOptionsBase {
  ...
  /** Cell glyph strategy. "half-block" packs 2 pixels per cell using U+2580 with fg+bg, "background" packs 1 pixel per cell as a space with bg only (no seams on Terminal.app). undefined auto-detects from TERM_PROGRAM (default: undefined) */
